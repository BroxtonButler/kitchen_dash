### SOFT FINISHED - could still add a timer possibly ###
### skill check for kitchen game - spam two keys in a certain time frame to complete the check
...
pygame.display.set_caption("Spamming Keys Check")
